...
abstract class modArticlesNewsSvwHelper
{
	public static function getList(&$params)
	{
		...
		foreach ($items as &$item) {
			...
			if ($access || in_array($item->access, $authorised))
			{
				...
				$item->linkText = JText::_('MOD_ARTICLES_NEWS_SVW_READMORE');
			}
			else {
				$item->link = JRoute::_('index.php?option=com_users&view=login');
				$item->linkText = JText::_('MOD_ARTICLES_NEWS_SVW_READMORE_REGISTER');
			}
